...
def convertVd(vdFilePath):
    ...
    svgNode.attributes['viewBox'] = '0 0 {} {}'.format(vdNode.attributes['android:viewportWidth'].value,
    ...
    for vdGroup in vdGroups:
        ...
        if vdGroup.hasAttribute('android:translateX'):
            svgGroup.attributes['transform'] = 'translate({},{})'.format(vdGroup.attributes['android:translateX'].value,
    ...
    # write xml to file
    svgXml.writexml(open(vdFilePath.split('.')[0] + '.svg', 'w'), indent="", addindent="  ", newl='\n')

print('\033[1;32;40m')
print("***************王小二SVG转化工具****************")
print("开始转化-程序员-binhongwang")
